...
#SBATCH --mem=512GB
#SBATCH --job-name=jobsub_populations_pi_nowss_%j
#SBATCH --mail-user=roseanna.gamlen.greene@gmail.com
#SBATCH --mail-type=ALL
#SBATCH --output=jobsub_populations_pi_nowss_%j.out
...
# rsync -zv /drives/f/GBS_data_03_02_21/Lane_1_2_3_feb2023/jobsub_populations_pi_nowss.sh roseanna@cedar.computecanada.ca:/home/roseanna/scratch/ANBO_refassembly_HGthesis_lane1_lane2_lane3/ --progress

# rsync -zv roseanna@cedar.computecanada.ca:/home/roseanna/scratch/ANBO_refassembly_HGthesis_lane1_lane2_lane3/jobsub_populations_pi_nowss_ /drives/f/GBS_data_03_02_21/Lane_1_2_3_feb2023/ --progress
...
# mkdir populations_ANBOref_r60_R60pctoverall_mm001_mh06

echo “Starting populations_ANBOref_r60_R60pctoverall_mm001_mh06 at: `date`”

populations -P $src/ANBO_refassembly_HGthesis_lane1_lane2_lane3/gstacks_minmapq20_1370/ -M $src/info/Pop_map_HGthesis_lane1_allexcptexperimnt_lane2_LM_VanIs_lane3_NW_siteID.tsv -O $src/ANBO_refassembly_HGthesis_lane1_lane2_lane3/gstacks_minmapq20_1370/populations_ANBOref_r60_R60pctoverall_mm001_mh06/ --max-obs-het 0.6 --min-samples-overall 0.6 --min-samples-per-pop 0.6 --min-maf 0.01 --fstats --hwe --smooth --smooth-fstats --vcf --vcf-all --plink --structure --genepop --treemix --verbose -t $cpu
