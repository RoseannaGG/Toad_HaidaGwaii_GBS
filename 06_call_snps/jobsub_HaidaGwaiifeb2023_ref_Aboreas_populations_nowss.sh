...
#SBATCH --mem=512G
#SBATCH --job-name=jobsub_HaidaGwaiifeb2023_ref_Aboreas_populations_nowss_nowss
#SBATCH --mail-user=roseanna.gamlen.greene@gmail.com
#SBATCH --mail-type=ALL
#SBATCH --output=jobsub_HaidaGwaiifeb2023_ref_Aboreas_populations_nowss_nowss_%j.out 

# rsync -zv /drives/f/GBS_data_03_02_21/HaidaGwaii_ref_Aboreas/jobsub_HaidaGwaiifeb2023_ref_Aboreas_populations_nowss.sh roseanna@cedar.computecanada.ca:/home/roseanna/scratch/HaidaGwaii_Aboreas/ --progress

# rsync -zv /drives/f/GBS_data_03_02_21/HaidaGwaii_ref_Aboreas/jobsub_HaidaGwaiifeb2023_ref_Aboreas_populations_nowss.sh roseanna@beluga.computecanada.ca:/home/roseanna/scratch/HaidaGwaii_Aboreas/ --progress

# rsync -zv roseanna@beluga.computecanada.ca:/home/roseanna/scratch/HaidaGwaii_Aboreas/jobsub_HaidaGwaiifeb2023_ref_Aboreas_populations_nowss_35213589.out /drives/f/GBS_data_03_02_21/HaidaGwaii_ref_Aboreas/ --progress
